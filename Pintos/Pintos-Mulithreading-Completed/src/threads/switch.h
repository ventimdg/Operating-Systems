...
/* Define the FPU Save State Size*/
#define FPU_SIZE 108

#ifndef __ASSEMBLER__
/* switch_thread()'s stack frame. */
struct switch_threads_frame {
  /* Add the save state of the FPU. */
  uint8_t fpu[FPU_SIZE]; /* FPU Save State. */
...
#define SWITCH_CUR 128  // Changed from 20
#define SWITCH_NEXT 132 // Changed from 24
